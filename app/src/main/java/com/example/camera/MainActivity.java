                ...
                videoCapture.startRecording(
                        ...
                        new VideoCapture.OnVideoSavedCallback() {
                            ...
                            public void onVideoSaved(@NonNull VideoCapture.OutputFileResults outputFileResults) {
                                Toast.makeText(MainActivity.this, "Video lưu thành công.", Toast.LENGTH_SHORT).show();
                            }
                            @Override
                            public void onError(int videoCaptureError, @NonNull String message, @Nullable Throwable cause) {
                                Toast.makeText(MainActivity.this, "Lỗi lưu video: " + message, Toast.LENGTH_SHORT).show();
                            }
                        }
                );
        ...
        imageCapture.takePicture(
                ...
                new ImageCapture.OnImageSavedCallback() {
                    ...
                    public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                        Toast.makeText(MainActivity.this, "Ảnh lưu thành công.", Toast.LENGTH_SHORT).show();
                    }
                    @Override
                    public void onError(@NonNull ImageCaptureException exception) {
                        Toast.makeText(MainActivity.this, "Lỗi lưu ảnh: " + exception.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
    }
